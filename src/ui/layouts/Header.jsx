    ...
    <header className="flex items-center justify-between">
      <div className="mb-2 p-1">
        <Link className="flex items-center space-x-2  text-red-50" to={ROOT}>
          ...
          <h1 className="p-2 text-center text-2xl leading-10 tracking-tight text-main-red-dark sm:leading-none md:text-4xl lg:text-5xl">
      ...
      <nav>
        <div className="text-md me-6 flex h-min space-x-2 font-medium text-secondary-red-dark">
          <Link
